    ...
    def export(
        ...
        for i, state in enumerate(states):
            ...
            lines.append(
                ...
                f"{sanitized} = {state_bits}'b{encoding};"
            )
        lines.append("")
        ...
        if fsm_type == "moore":
            ...
            for state in states:
                ...
                lines.append(
                    f"            {sanitized}: out = {output_bits}'b{output_val};"
                )
        ...
        for state in states:
            ...
            for t in state_trans:
                ...
                if out_val and inp:
                    ...
                    lines.append(
                        f"                    out = {output_bits}'b{out_val};"
                    )
            lines.append("            end")

        lines.append(
            f"            default: out = {output_bits}'b{'0' * output_bits};"
        )
